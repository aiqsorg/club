        ...
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg mx-auto">
            <p className="text-lg md:text-xl mb-8 leading-relaxed">
              We are a group of inventive and perspicacious problem solvers that enjoy applying statistics to capture an edge in markets where others may not think to look
            </p>
