      ...
      <div className="flex-grow flex flex-col items-center justify-center py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
            <span className="text-[#C8102E]">A</span>lternative <span className="text-[#C8102E]">I</span>nvestments & <span className="text-[#C8102E]">Q</span>uantitative <span className="text-[#C8102E]">S</span>olutions
          </h1>
