  ...
  const renderShape = () => {
    switch (number) {
      ...
      case 2: // Triangle
        return (
          <div className="relative">
            <div className="w-0 h-0 border-l-[30px] md:border-l-[40px] border-r-[30px] md:border-r-[40px] border-b-[52px] md:border-b-[69px] border-l-transparent border-r-transparent border-b-[#C8102E] flex items-center justify-center transition-all duration-300 transform group-hover:scale-110" />
          </div>
        );
      case 3: // Square
        return (
