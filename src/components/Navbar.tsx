    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          ...
          {/* Linktree External Link */}
          <a
            href="https://linktr.ee/aiqsorg"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm font-medium tracking-wider transition-colors duration-200 border-b-2 pb-1 border-transparent hover:border-gray-300 text-black hover:text-gray-700"
          >
            RESOURCES
          </a>
        </div>
      ...
      >
        <div className="flex flex-col py-2 px-4 space-y-2">
          ...
          {/* Linktree External Link for Mobile */}
          <a
            href="https://linktr.ee/aiqsorg"
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => setIsOpen(false)}
            className="block py-2 text-sm font-medium tracking-wider text-black hover:text-gray-700"
          >
            LINKTREE
          </a>
        </div>
